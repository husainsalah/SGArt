...
import "defu";
import "destr";
const art_vue_vue_type_style_index_0_scoped_1ba6a813_lang = "";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div><div class="flex col-span-8 text-2xl font-thin text-gray-dark p-8" data-v-1ba6a813><a class="inline-flex" href="/" data-v-1ba6a813>Alia Benabdellah, Docteure en Géographie Humaine, in conversation with musician and artist Scott Grooves on August 8, 2023 </a></div></div></section>`);
...
//# sourceMappingURL=art-a2348ab5.js.map
