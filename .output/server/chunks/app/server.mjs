...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-72c1ca37.mjs').then((m) => m.default || m)
  },
  {
    name: "art",
    path: "/art",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/art-a2348ab5.mjs').then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/contact-de0f29c9.mjs').then((m) => m.default || m)
  },
  {
    name: "exhibitions",
    path: "/exhibitions",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/exhibitions-1504e424.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-8d5a837a.mjs').then((m) => m.default || m)
  },
  {
    name: "press",
    path: "/press",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/press-ae3bbe49.mjs').then((m) => m.default || m)
  },
  {
    name: "splash",
    path: "/splash",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/splash-2db262d8.mjs').then((m) => m.default || m)
  },
  {
    name: "splash2",
    path: "/splash2",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/splash2-1ecbd69f.mjs').then((m) => m.default || m)
  },
  {
    name: "theme",
    path: "/theme",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/theme-702d4aad.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-e92dbd2c.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-c756f07a.mjs').then((r) => r.default || r));
